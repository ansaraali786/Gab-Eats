    ...
    return (
      <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="mt-10 pt-10 border-t border-gray-100 w-full max-w-xs">
          <p className="text-[10px] font-black text-gray-300 uppercase tracking-widest">GAB-EATS Infrastructure Status: HOLD</p>
        </div>
      </div>
    );
  }
            ...
            <Link to={`/restaurant/${r.id}`}>
              <div className="h-64 relative overflow-hidden">
                ...
                <div className="absolute top-6 left-6 flex space-x-2">
                  ...
                  <div className="bg-teal-500/90 backdrop-blur px-3 py-1.5 rounded-xl text-xs font-black text-white flex items-center shadow-sm">
                    {r.deliveryTime}
                  </div>
                </div>
              </div>
              <div className="p-8">
                ...
                <div className="pt-6 border-t border-gray-50 flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 gradient-primary rounded-full flex items-center justify-center text-white shadow-lg shadow-orange-100 opacity-0 group-hover:opacity-100 transition-all">
